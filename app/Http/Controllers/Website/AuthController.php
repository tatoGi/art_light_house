...
class AuthController extends Controller
{
    /**
     * POST /register
     * Body: { first_name: string, email: string, password: string, password_confirmation: string, surname?: string }
     */
    ...
    public function me(Request $request)
    {
        ...
        if (!$user) {
            Log::info('User not authenticated via Sanctum');
            return response()->json([
                'success' => false,
    ...
    /**
     * GET /language - Get current language/locale information for frontend
     */
