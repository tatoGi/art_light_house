<x-Admin.AdminLayout>
    ...
    <div class="flex flex-wrap my-5 -mx-2">
        ...
        <div class="flex justify-between w-full px-2">
            ...
            <a href="/{{ app()->getlocale() }}/admin/options/create" class="btn  flex overflow-hidden relative w-40 bg-blue-500 text-white py-2 px-4 rounded-xl font-bold uppercase 
