                    ...
                    @forelse($languages as $language)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                @if(!$language->is_default)
                                    <form action="/{{ app()->getLocale() }}/admin/languages/{{ $language->id }}/destroy" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this language?');">
                                        @csrf
                                        @method('DELETE')
