...
<aside class="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
        ...
        <div class="flex pl-4 items-center space-x-2 ">
            <div>
                <div onclick="setDark('dark')"
                    class="moon text-white hover:text-blue-500 dark:hover:text-blue-500 dark:text-gray-400">
                ...
                <div onclick="setDark('light')"
                    class="sun hidden text-white hover:text-blue-500 dark:hover:text-blue-500 dark:text-gray-400">
    ...
    <div class="max hidden overflow-x-hidden overflow-y-scroll text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
                    ...
                    <div class="absolute mt-8 ml-6 w-[200px] bg-[#1E293B] rounded-lg shadow-lg z-10 hidden
                        ...
                        <div class="py-1">
                            @foreach ($link['submenu'] as $submenu)
                                <a href="/{{ app()->getlocale() }}/{{ $submenu['url'] }}"
                                    class="block px-4 w-full mb-2 py-2 text-sm text-white hover:bg-purple-500">{{ $submenu['title'] }}</a>
                            @endforeach
                        </div>
                    </div>
                </div>
